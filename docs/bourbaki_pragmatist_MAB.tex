...
% ------------------------------------------------- %
\begin{abstract}
These pages are aimed to introducing the multi-armed bandits problem with two different pedagogical approaches named \emph{Bourbachist} and \emph{pragmatic}. The Bourbakist way is concerned with the mathematical foundation upon which a formal solution to the problem is shaped into an axiomatic structure. In contrast, the pragmatic approach provides an algorithmic solution underpinned by the bare minimum mathematical formalism.
