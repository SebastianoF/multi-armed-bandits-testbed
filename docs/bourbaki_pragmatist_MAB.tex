...
% ------------------------------------------------- %
\begin{abstract}
In these pages are aimed to introducing the well known multi-armed bandits problem. It moves towards a solution via two different pedagogical approaches, here titled \emph{Bourbachist} and \emph{pragmatic}. The Bourbakist way is concerned with the mathematical foundation upon which a formal solution is shaped into an axiomatic structure. In contrast, the pragmatic approach provides an algorithmic solution, and exposes it with the bare minimum mathematical formalism.
...
The MAB problem arises in contexts that are more interesting than gambling, for which we do not advocate. These contexts can be clinical or pre-clinical trials, control engineering, mechanical and software testing, stock market investments, behavioural modelling, dynamic pricing, and many more\footnote{
...
The goal of these pages is to introduce the problem and to provide a solution with two different methodologies:
\begin{itemize}
